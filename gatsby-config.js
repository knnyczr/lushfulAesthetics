...
// Skip Contentful entirely for development unless explicitly provided
const useContentful = process.env.CONTENTFUL_SPACE_ID && 
                     process.env.CONTENTFUL_ACCESS_TOKEN && 
                     process.env.CONTENTFUL_SPACE_ID !== "test" && 
                     process.env.CONTENTFUL_ACCESS_TOKEN !== "test";

const contentfulConfig = {
  spaceId: process.env.CONTENTFUL_SPACE_ID || "test",
...
// Only add Contentful when credentials are properly configured
if (useContentful) {
  plugins.push({
...
plugins.push(
  ...
  // Conditionally add advanced sitemap only when Contentful is available
  ...(useContentful ? [{
