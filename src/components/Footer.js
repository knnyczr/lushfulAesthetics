    ...
    <>
      <div className="bg-main-green text-white lg:px-24 lg:pt-12 md:px-12 md:pt-12 md:pb-4 px-4 py-4">
        <div className="flex lg:flex-row lg:justify-between md:flex-col flex-col ">
          <div className="flex lg:flex-row lg:justify-between md:flex-col flex-col">
            <div className="lg:pr-32 md:pr-16 md:pb-16 pr-8 py-4 ">
              <Link to="/">
                <StaticImage
          ...
          <div className="flex flex-row items-end py-4 md:pb-16">
            ...
            <Link to="" className="text-base md:text-lg mb-4">
              TikTok
            </Link>
          </div>
        </div>
